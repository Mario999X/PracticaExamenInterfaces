...
public class AppGrafLineasController implements Initializable {
    ...
    public void iniciarGrafica(){
        ...
        XYChart.Series serieAnfibio = new XYChart.Series();
        serieAnfibio.setName("Anfibio");
        serieAnfibio.getData().add(new XYChart.Data("2015", 1));
        serieAnfibio.getData().add(new XYChart.Data("2016", 1));
        serieAnfibio.getData().add(new XYChart.Data("2017", 1));
        serieAnfibio.getData().add(new XYChart.Data("2018", 1));
        serieAnfibio.getData().add(new XYChart.Data("2019", 1));
        serieAnfibio.getData().add(new XYChart.Data("2020", 0.9));
        ...
        grafLineas.getData().addAll(serieMamifero, serieAnfibio, serieAve, serieReptil);
    }
